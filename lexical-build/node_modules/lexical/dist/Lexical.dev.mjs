...
function $updateDOMSelection(prevSelection, nextSelection, editor, domSelection, tags, rootElement) {
  ...
  if (!$isRangeSelection(nextSelection)) {
    ...
    // lose focus.
    if (prevSelection !== null && isSelectionWithinEditor(editor, domSelection.anchorNode, domSelection.focusNode)) {
      domSelection.removeAllRanges();
    }
    return;
  }
  ...
  // Badly interpreted range selection when collapsed - #1482
  domSelection.anchorOffset === nextAnchorOffset && domSelection.focusOffset === nextFocusOffset && domSelection.anchorNode === nextAnchorNode && domSelection.focusNode === nextFocusNode) {
