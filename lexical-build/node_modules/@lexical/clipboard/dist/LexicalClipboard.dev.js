 ...
 * ```
 */
const ClipboardImportExtension = lexical.defineExtension({
 ...
 * ```
 */
const ClipboardDOMImportExtension = lexical.defineExtension({
  dependencies: [extension.configExtension(ClipboardImportExtension, {
    $importMimeType: {
 ...
 * ```
 */
const GetClipboardDataExtension = lexical.defineExtension({
