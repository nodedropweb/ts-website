...
<div class="mb-3">
    <a href="faq-edit.php" class="btn btn-primary">
        <i class="fas fa-plus"></i> Neuer FAQ-Eintrag
    </a>
</div>
...
<div class="card">
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            ...
            if (empty($faqs)): ?>
                <tr><td colspan="4" class="text-center text-muted py-4">Keine FAQ-Einträge vorhanden.</td></tr>
            <?php else:
                foreach ($faqs as $faq): ?>
                <tr>
                    <td class="text-muted"><?= $faq['faqid'] ?></td>
                    <td><?= htmlspecialchars(mb_strimwidth($faq['question'], 0, 80, '…')) ?></td>
                    ...
                    <td class="text-right">
                        ...
                        <form method="post" action="api/faq.php" style="display:inline"
                              onsubmit="return confirm('FAQ-Eintrag wirklich löschen?')">
